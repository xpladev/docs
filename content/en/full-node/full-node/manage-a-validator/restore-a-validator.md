...
A validator can be completely restored on a new CONX Chain node with the following set of keys:
...
1. Setup a full CONX Chain node synced up to the latest block.
